...
# next works fine...
New-AzureService -ServiceName "DenService" -Label "MyTestService" -Location "West Europe"
$azureClassicService = "DenService"
...
azure network vnet subnet create -t DenVirtualNetwork -n BackEnd -a 192.168.2.0/24
